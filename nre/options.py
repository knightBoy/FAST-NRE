...
def model_opts(parser):
    ...
    group.add_argument('-model_type', type=str, default='BiRNN+ATT', help='Name of used model, e.g. cnn+att, dcnn+att, pdcnn+att')
    ...
    # BiRNN encoder options
    group = parser.add_argument_group('Model-Layers-BiRNNEncoder')
    group.add_argument('-rnn_type', type=str, default='LSTM', help="RNN type for BiRNN encoder, e.g. LSTM, GRU")
    group.add_argument('-rnn_layer_num', type=int, default=1, help="The layer number of the RNN encoder")
    group.add_argument('-rnn_hidden_size', type=int, default=115, help='The hidden state dimension of rnn')
    group.add_argument('-bidirectional', type=bool, default=True, help='Bidirectional RNN or not')
    ...
    group.add_argument('-seed', type=int, default=19950805, help="The seed for generating random numbers")
