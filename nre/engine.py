...
class Engine(object):
    ...
    def __init__(self, opt):
        ...
        self.gpu_utils.init_params(opt)
    ...
    def train(self, opt):
        ...
        while step <= opt.train_steps:
            for _, batch in enumerate(
                ...
                loss, accuracy = self.model(True, batch_word, batch_pos1, batch_pos2, batch_mask, batch_type, batch_lens,
                    batch_scope, batch_type_label, batch_label, label_for_select)
    ...
    def eval(self, is_eval, opt):
        ...
        with torch.no_grad():
            for i, batch in enumerate(
                ...
                test_output = self.model(False, batch_word, batch_pos1, batch_pos2, batch_mask, batch_type, batch_lens, batch_scope, batch_type_label)
